...
class Character : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        inventoryListView.adapter = InventoryView(hidden, animUpText!!, animDownText!!, player, textViewInfoItem, buttonBag0, buttonBag1, lastClicked, textViewInfoCharacter, equipDragListener, runesDragListener, bagViewv,equipView,
            ...
            viewHolder.buttonInventory1.setOnTouchListener(object : Class_OnSwipeTouchListener(context) {
                ...
                override fun onLongClick() {
                    ...
                    when(playerC.inventory[index]){
                        is Weapon, is Wearable ->equipView.setOnDragListener(equipDragListener)
                        is Runes ->bagView.setOnDragListener(runesDragListener)
                    }
