                    ...
                    MotionEvent.ACTION_UP -> {
                        ...
                        if (lastAction == MotionEvent.ACTION_DOWN) {
                            ...
                            val displayXHalf = displayMetrics.widthPixels / 2
                                ...
                                handler.postDelayed({
                                when {
                                    (initialX + (event.rawX - initialTouchX).toInt()) >= displayXHalf -> {
                                ...
                                when {
                                    (initialY + (event.rawY - initialTouchY).toInt()) <= displayYPercent * 10 -> {
                                    ...
                                    (initialY + (event.rawY - initialTouchY).toInt()) >= displayYPercent * 80 -> {
