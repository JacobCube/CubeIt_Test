...
data class Player(
        ...
        var backpackRunes: Array<Runes?>,
        var learnedSpells:MutableList<Spell?>,
        var chosenSpellsDefense:MutableList<Spell?>,
        var chosenSpellsAttack:Array<Spell?>,
        var money:Int,
        var shopOffer:Array<Item?>,
    ...
    fun uploadPlayer(){ // uploads player to Firebase (will need to use userSession)
        ...
        for(i in 0 until tempInventory.size){
