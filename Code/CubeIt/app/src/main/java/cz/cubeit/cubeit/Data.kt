...
data class Player(val username:String, var look:Array<Int>, var level:Int, val charClass:Int, var power:Int, var armor:Int, var block:Double, var poison:Int, var bleed:Int, var health:Double, var energy:Int,
    ...
    fun loadPlayer() { // loads the player from Firebase
        ...
        docRef.get().addOnSuccessListener { documentSnapshot ->
            ...
            this.adventureSpeed
            this.inventorySlots
            this.inventory = documentSnapshot.data!!["inventory"] as MutableList<Item?>
            this.equip.toMutableList()
            this.backpackRunes.toMutableList()
            this.learnedSpells
            this.chosenSpellsDefense
            this.chosenSpellsAttack.toMutableList()
            this.money
            this.shopOffer.toMutableList()
            this.notifications*/
