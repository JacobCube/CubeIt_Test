...
class CharClass(
    ...
    var drawable: Int = drawableStorage[inDrawable]!!
        get() = drawableStorage[inDrawable]!!
    var itemList: MutableList<Item> = itemClasses[itemListIndex].items
        get() = itemClasses[itemListIndex].items
    var spellList: MutableList<Spell> = spellClasses[spellListIndex].spells
        get() = spellClasses[spellListIndex].spells
    var itemListUniversal: MutableList<Item> = itemClasses[itemlistUniversalIndex].items
        get() = itemClasses[itemlistUniversalIndex].items
    var spellListUniversal: MutableList<Spell> = spellClasses[spellListUniversalIndex].spells
