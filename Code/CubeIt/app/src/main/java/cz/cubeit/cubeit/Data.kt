...
open class Quest(val name:String = "", val description:String = "", val level:Int = 0, val experience:Int = 0, val money:Int = 0, val surface:Int = 0)
...
val surfaces:Array<Surface> = arrayOf(Surface(R.drawable.map0, arrayOf(
        Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 1*25, 1*10, 0),
        Quest("Quest 2", "Description of quest 2", 1, 2*25, 2*10, 0),
        Quest("Quest 3", "Description of quest 3", 2, 3*25, 3*10, 0),
        Quest("Quest 4", "Description of quest 4", 3, 4*25, 4*10, 0),
        Quest("Quest 5", "Description of quest 5", 4, 5*25, 5*10, 0),
        Quest("Quest 6", "Description of quest 6", 5, 6*25, 6*10, 0),
        Quest("Quest 7", "Description of quest 7", 6, 7*25, 7*10, 0)), arrayOfNulls(7)),

        Surface(R.drawable.map1, arrayOf(
                Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 8*25, 1*10, 1),
                Quest("Quest 9", "Description of quest 2", 1, 9*25, 2*10, 1),
                Quest("Quest 10", "Description of quest 3", 2, 10*25, 3*10, 1),
                Quest("Quest 11", "Description of quest 4", 3, 11*25, 4*10, 1),
                Quest("Quest 12", "Description of quest 5", 4, 12*25, 5*10, 1),
                Quest("Quest 13", "Description of quest 6", 5, 13*25, 6*10, 1),
                Quest("Quest 14", "Description of quest 7", 6, 14*25, 7*10, 1)), arrayOfNulls(7)),

        Surface(R.drawable.map2, arrayOf(
                Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 15*25, 1*10, 2),
                Quest("Quest 16", "Description of quest 2", 1, 16*25, 2*10, 2),
                Quest("Quest 17", "Description of quest 3", 2, 18*25, 3*10, 2),
                Quest("Quest 18", "Description of quest 4", 4, 19*25, 4*10, 2),
                Quest("Quest 19", "Description of quest 5", 4, 20*25, 5*10, 2),
                Quest("Quest 20", "Description of quest 6", 5, 21*25, 6*10, 2),
                Quest("Quest 21", "Description of quest 7", 6, 22*25, 7*10, 2)), arrayOfNulls(7)),

        Surface(R.drawable.map3, arrayOf(
                Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 23*25, 1*10, 3),
                Quest("Quest 23", "Description of quest 2", 1, 24*25, 2*10, 3),
                Quest("Quest 24", "Description of quest 3", 2, 25*25, 3*10, 3),
                Quest("Quest 25", "Description of quest 4", 3, 26*25, 4*10, 3),
                Quest("Quest 26", "Description of quest 5", 4, 27*25, 5*10, 3),
                Quest("Quest 27", "Description of quest 6", 5, 28*25, 6*10, 3),
                Quest("Quest 28", "Description of quest 7", 6, 29*25, 7*10, 3)), arrayOfNulls(7)),

        Surface(R.drawable.map4, arrayOf(
                Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 30*25, 1*10, 4),
                Quest("Quest 30", "Description of quest 2", 1, 31*25, 2*10, 4),
                Quest("Quest 31", "Description of quest 3", 2, 32*25, 3*10, 4),
                Quest("Quest 32", "Description of quest 4", 3, 33*25, 4*10, 4),
                Quest("Quest 33", "Description of quest 5", 4, 34*25, 5*10, 4),
                Quest("Quest 34", "Description of quest 6", 5, 35*25, 6*10, 4),
                Quest("Quest 35", "Description of quest 7", 6, 36*25, 7*10, 4)), arrayOfNulls(7)),

        Surface(R.drawable.map5, arrayOf(
                Quest("Run as fast as you can, boiiiii", "Hope you realise, that if you didn't smoke so much, it would be way easier", 1, 37*25, 1*10, 5),
                Quest("Quest 37", "Description of quest 2", 1, 38*25, 2*10, 5),
                Quest("Quest 38", "Description of quest 3", 2, 39*25, 3*10, 5),
                Quest("Quest 39", "Description of quest 4", 3, 40*25, 4*10, 5),
                Quest("Quest 40", "Description of quest 5", 4, 41*25, 5*10, 5),
                Quest("Quest 41", "Description of quest 6", 5, 42*25, 6*10, 5),
                Quest("Quest 42", "Description of quest 7", 6, 43*25, 7*10, 5)), arrayOfNulls(7)))
