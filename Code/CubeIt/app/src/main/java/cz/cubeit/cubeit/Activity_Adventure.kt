...
class Adventure : AppCompatActivity() {
    ...
    fun onClickQuestSideQuest(surface:Int, index:Int, context:Context){
        ...
        textViewName.text = surfaces[surface].quests[index].name
        textViewDescription.text = surfaces[surface].quests[index].description
        textViewLevel.text = surfaces[surface].quests[index].level.toString()
        textViewMoney.text = surfaces[surface].quests[index].money.toString()
        textViewExperience.text = surfaces[surface].quests[index].experience.toString()
