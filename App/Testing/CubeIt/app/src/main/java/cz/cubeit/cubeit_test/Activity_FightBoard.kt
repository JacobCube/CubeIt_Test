...
class ActivityFightBoard: SystemFlow.GameActivity(R.layout.activity_fight_board, ActivityType.FightBoard, true, R.id.imageViewActivityFightBoard, R.color.colorSecondary, hasSwipeMenu = false){
    ...
    override fun dispatchTouchEvent(ev: MotionEvent): Boolean {
        ...
        if(!viewRectCompare.contains(ev.rawX.toInt(), ev.rawY.toInt()) && !viewRectCompareCharacter.contains(ev.rawX.toInt(), ev.rawY.toInt()) && ev.action == MotionEvent.ACTION_UP){
