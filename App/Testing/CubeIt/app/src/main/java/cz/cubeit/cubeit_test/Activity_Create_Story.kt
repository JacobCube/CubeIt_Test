...
class Activity_Create_Story: SystemFlow.GameActivity(contentLayoutId = R.layout.activity_create_story, activityType = ActivityType.CreateStory, hasMenu = false, hasSwipeDown = false){
    ...
    private class CreateStoryOverviewSecondary(var bitmaps: MutableList<Bitmap?>, var ratioDescriptions: MutableList<String>, val activity: Activity_Create_Story, val template: SystemFlow.FrameworkComponentTemplate) :
        ...
        override fun onBindViewHolder(viewHolder: CategoryViewHolder, position: Int) {
            ...
            viewHolder.imageViewBg.setOnClickListener {
                val component = SystemFlow.FrameworkComponent(
                        ...
                        width = 60f,
                        height = 60f,
                        bitmapId = Data.storageIdentifiers.mapStoryComponents[position],
                        rotationAngle = 0f,
            ...
            viewHolder.imageViewBg.setOnLongClickListener {
                ...
                val myShadow = SystemFlow.StoryDragListener(null, component.realWidth, component.realHeight, component.rotationAngle, BitmapDrawable(activity.resources , Data.downloadedBitmaps[Data.storageIdentifiers.mapStoryComponents[position]]))
