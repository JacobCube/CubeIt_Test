...
class Activity_Market: SystemFlow.GameActivity(R.layout.activity_market, ActivityType.Market, true, R.id.layoutMarket, R.color.colorSecondary, hasSwipeMenu = false){
...
class MarketItemsList(private var itemsListAdapter: MutableList<MarketOffer>, val activity: Activity_Market, val textViewMoney: TextView) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, viewGroup: ViewGroup?): View {
        ...
        viewHolder.imageViewMarketItem.setBackgroundResource(itemsListAdapter[position].item?.getBackground() ?: 0)
        ...
        viewHolder.imageViewMarketItem.setOnTouchListener(object: Class_HoldTouchListener(viewHolder.imageViewMarketItem, false, 0f, false){
            ...
            override fun onStartHold(x: Float, y: Float) {
                ...
                if(!windowPop.isShowing && !viewPinned){
                    ...
                    viewP.imageViewPopUpInfoItem.setBackgroundResource(itemsListAdapter[position].item?.getBackground() ?: 0)
