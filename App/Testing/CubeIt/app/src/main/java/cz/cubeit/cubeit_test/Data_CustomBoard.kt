...
object CustomBoard: Serializable {
    ...
    */
    ...
    class BoardList(
         ...
         */
        fun loadPackage(limit: Long = 10, context: Context, filter: Pair<String, Any>? = null): Task<QuerySnapshot> {
            ...
            if(filter != null){
                Log.d("loadPackage", "${filter.first} to ${filter.second}")
        ...
        fun isLoadable(context: Context): Boolean{
            ...
            return diff / 1000 / 60 >= type.getMinuteDelay()                //is the time difference higher than X minutes?
        }
