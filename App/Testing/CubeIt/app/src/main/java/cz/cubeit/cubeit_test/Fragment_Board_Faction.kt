...
class Fragment_Board_Faction : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        view.progressBarBoardFactionXp.max = (chosenFaction.level * chosenFaction.level * GenericDB.balance.playerXpRequiredLvlUpRate).toInt()
        view.progressBarBoardFactionXp.progress = chosenFaction.experience
        view.textViewBoardFactionXp.setHTMLText(GameFlow.experienceScaleFormatString(chosenFaction.experience, null, chosenFaction.level))
