    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.window.decorView.rootView.post {
            ...
            imageViewHomeBoard.setOnClickListener{
                ...
                val intent = Intent(this, cz.cubeit.cubeit_test.ActivityFightBoard::class.java)
                startActivity(intent)
                this.overridePendingTransition(0,0)
            }
            ...
            imageViewHomeCharacter.setOnClickListener{
                ...
                val intent = Intent(this, cz.cubeit.cubeit_test.Activity_Character::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP
                startActivity(intent)
                this.overridePendingTransition(0,0)
            }
            imageViewHomeSettings.setOnClickListener{
                ...
                val intent = Intent(this, cz.cubeit.cubeit_test.ActivitySettings::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP
                startActivity(intent)
                this.overridePendingTransition(0,0)
            }
            imageViewHomeShop.setOnClickListener {
                ...
                val intent = Intent(this, cz.cubeit.cubeit_test.Activity_Shop::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP
                startActivity(intent)
                this.overridePendingTransition(0,0)
            }
            imageViewHomeAdventure.setOnClickListener{
                ...
                val intent = Intent(this, cz.cubeit.cubeit_test.ActivityAdventure::class.java)
                intent.flags = Intent.FLAG_ACTIVITY_CLEAR_TOP
                startActivity(intent)
                this.overridePendingTransition(0,0)
            }
