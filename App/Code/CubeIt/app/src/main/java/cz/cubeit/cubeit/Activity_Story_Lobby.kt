...
class Activity_Story_Lobby: SystemFlow.GameActivity(R.layout.activity_story_lobby, ActivityType.StoryLobby, true, R.color.colorSecondary, hasSwipeMenu = false, hasSwipeDown = false){
