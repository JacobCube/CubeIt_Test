                    ...
                    if(!tempView.editTextMarketRegisterUntilDate.text.isNullOrBlank()) {
                        ...
                        if(tempView.editTextMarketRegisterCoins.text.toString().toIntOrNull() != null && (tempView.editTextMarketRegisterCoins.text.toString().toInt() >= createdOffer.item!!.priceCubeCoins && tempView.editTextMarketRegisterCubeCoins.text.toString().toInt() >= createdOffer.item!!.priceCubix)){
                            ...
                            if (!createdOffer.closeAfterExpiry && tempView.editTextMarketRegisterLowerCoins.text.isNullOrBlank() && tempView.editTextMarketRegisterLowerCubeCoins.text.isNullOrBlank()) {
                                ...
                                with(createdOffer) {
                                    if (!closeAfterExpiry) {
                                        afterExpiryCubeCoins = tempView.editTextMarketRegisterLowerCoins.text.toString().toLongOrNull() ?: createdOffer.item!!.priceCubeCoins
                                        afterExpiryCubix = tempView.editTextMarketRegisterCubeCoins.text.toString().toLongOrNull() ?: createdOffer.item!!.priceCubix
                                    }
                                    ...
                                    priceCubeCoins = tempView.editTextMarketRegisterCoins.text.toString().toLongOrNull() ?: createdOffer.item!!.priceCubeCoins
                                    ...
                                    priceCubix = tempView.editTextMarketRegisterCubeCoins.text.toString().toLongOrNull() ?: createdOffer.item!!.priceCubix
