...
open class NPC(
    ...
    @Exclude @Transient var bgDrawable: Int = 0
        @Exclude get() = drawableStorage[inBgDrawable] ?: R.drawable.character_0
     ...
     */
    fun calcSpell(allies: MutableList<FightSystem.Fighter>, enemies: MutableList<FightSystem.Fighter>, round: Int, myEnergy: Int): String {
        ...
        for (i in (Memory.lastChosenEnemy.sourceNPC?.charClass?.spellList ?: Memory.lastChosenEnemy.sourcePlayer?.charClass?.spellList)!!) {
        ...
        playerSpells.addAll((Memory.lastChosenEnemy.sourceNPC?.allowedSpells ?: Memory.lastChosenEnemy.sourcePlayer?.chosenSpellsAttack)!!.filterNotNull().toMutableList())
        playerSpells.add(Memory.lastChosenEnemy.sourceNPC?.allowedSpells?.get(0) ?: Memory.lastChosenEnemy.sourcePlayer?.learnedSpells!![0]!!)
        playerSpells.add(Memory.lastChosenEnemy.sourceNPC?.allowedSpells?.get(1) ?: Memory.lastChosenEnemy.sourcePlayer?.learnedSpells!![1]!!)
