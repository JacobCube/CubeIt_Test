    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        if(arguments?.getString("type")=="read"){
            ...
            if((activity as Activity_Inbox).chosenMail.reward != null){
                ...
                view.textViewInboxMessageCoins.text = "cubeCoins: ${(activity as Activity_Inbox).chosenMail.reward!!.cubeCoins}"
                view.textViewInboxMessageCubeCoins.text = "cubix: ${(activity as Activity_Inbox).chosenMail.reward!!.cubix}"
                            ...
                            if(view.editTextInboxReciever.text.toString().isNotEmpty()){
                                ...
                                if(view.editTextInboxContent.text.toString().length < 500){
                                    Data.player.writeInbox(view.editTextInboxReciever.text.toString(), InboxMessage(
                                        ...
                                        Snackbar.make(view, "Message to ${view.editTextInboxReciever.text} has been sent.", Snackbar.LENGTH_SHORT).show()
                                    }.continueWithTask {
