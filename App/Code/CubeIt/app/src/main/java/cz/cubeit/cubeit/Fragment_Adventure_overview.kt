...
class AdventureQuestsOverview(var sideQuestsAdventure: MutableList<Quest>, val context: Context, val popupView:View, var progressBar: ProgressBar, var textView: TextView, val viewPopUpQuest: View, val viewPager: ViewPager, val adapter: ListView, val fragmentOverview: Fragment, val activity: Activity) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, viewGroup: ViewGroup?): View {
        ...
        if (convertView == null) {
            ...
            val viewHolder = ViewHolder(rowMain.imageViewBackground, rowMain.textViewName, rowMain.textViewDifficulty, rowMain.textViewOverviewRowExperience, rowMain.textViewOverviewRowMoney, rowMain.imageViewAdventureOverview, rowMain.textViewLength, rowMain.imageViewAdventureOverviewClick)
        ...
        viewHolder.textViewMoney.text = "${sideQuestsAdventure[position].money} cube coins"
        ...
        viewHolder.imageViewAdventureOverviewClick.setOnClickListener {
    ...
    private class ViewHolder(val imageViewBackground:ImageView, val textViewName:TextView, val textViewDifficulty: CustomTextView, val textViewExperience:TextView, val textViewMoney:TextView, val imageViewAdventureOverview:ImageView, val textViewLength: TextView, val imageViewAdventureOverviewClick: ImageView)
}