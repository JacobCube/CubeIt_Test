...
open class Class_OnSwipeTouchListener(c: Context, val view: View, val longPressable: Boolean) : View.OnTouchListener {      //TODO special effects on dragging the spell
