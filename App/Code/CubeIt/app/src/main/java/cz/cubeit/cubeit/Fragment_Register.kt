...
class Fragment_Register : SystemFlow.GameFragment(R.layout.fragment_register, R.id.layoutFragmentRegister) {
    lateinit var tempView: View
    private var passwordShown = false

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view:View = super.onCreateView(inflater, container, savedInstanceState) ?: inflater.inflate(R.layout.fragment_register, container, false)
        tempView = view

        view.textViewRegisterPrivacyPolicy.apply {
        ...
        view.post {
            if(activity != null){
                ...
                opts.inScaled = false
                view.imageViewRegisterIcon.setImageBitmap(BitmapFactory.decodeResource(activity!!.resources, R.drawable.icon_cubeit_login, opts))
                view.imageViewRegisterForm.setImageBitmap(BitmapFactory.decodeResource(activity!!.resources, R.drawable.register_window, opts))
            }
        }
        ...
        view.imageViewFragmentRegisterRegister.setOnClickListener {
            ...
            if (isConnected) {
                ...
                view.imageViewFragmentRegisterRegister.startAnimation(AnimationUtils.loadAnimation(view.context, R.anim.animation_shaky_short))
