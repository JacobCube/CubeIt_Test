...
class Activity_Story: SystemFlow.GameActivity(
    ...
    private class ViewPagerStorySlides internal constructor(fm: FragmentManager, private val storyQuest: StoryQuest) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT){
