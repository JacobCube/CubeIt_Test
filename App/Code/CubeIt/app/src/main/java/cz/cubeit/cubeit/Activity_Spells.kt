...
class Spells: SystemFlow.GameActivity(R.layout.activity_spells, ActivityType.Spells, true, R.id.viewPagerSpells, hasSwipeMenu = false){
...
class ViewPagerSpells internal constructor(fm: FragmentManager) : FragmentPagerAdapter(fm, BEHAVIOR_RESUME_ONLY_CURRENT_FRAGMENT){
