...
class ActivitySettings : SystemFlow.GameActivity(R.layout.activity_settings, ActivityType.Settings, true, R.id.imageViewActivitySettings, R.color.colorSecondary){
    ...
    override fun onCreate(savedInstanceState: Bundle?){
        ...
        //temporary
        var currentUUIDText = ""
        imageViewSettingFontRight.setOnLongClickListener {
            buttonSettingsGenerateUUID.visibility = View.VISIBLE
            textViewSettingsGenerateUUID.visibility = View.VISIBLE

            buttonSettingsGenerateUUID.setOnClickListener {
                currentUUIDText = if(currentUUIDText == ""){
                    UUID.randomUUID().toString()
                }else {
                    "${UUID.randomUUID()} ; $currentUUIDText"
                }
                textViewSettingsGenerateUUID.setHTMLText(currentUUIDText)
            }
            true
        }
