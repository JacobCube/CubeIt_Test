    ...
    companion object {
        private fun getDoubleClick(index:Int, context:Context, view:View, listViewInventoryShop:ListView, player:Player, textViewMoney:TextView, textViewInfoItem:TextView){
            ...
            buttonYes.setOnClickListener {
                Data.player.cubeCoins+=Data.player.inventory[index]!!.price
        ...
        private fun getDoubleClickOffer(index:Int, player:Player, error: TextView, textViewInfoItem:TextView, textViewMoney: TextView){
            if(Data.player.cubeCoins >= Data.player.shopOffer[index]!!.price && Data.player.cubix >= Data.player.shopOffer[index]!!.priceCubeCoins){
                if(Data.player.inventory.contains(null)){
                    error.visibility = View.INVISIBLE
                    Data.player.cubeCoins-=Data.player.shopOffer[index]!!.price
                    textViewMoney.text = Data.player.cubeCoins.toString()
                ...
                bubbleDialogShop(message = "Not enough cube coins!", error = error)
            }
        }
