...
class FragmentLogin : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        viewTemp.imageViewLoginOfflineMG.setImageBitmap(BitmapFactory.decodeResource(resources, R.drawable.mini_game_icon, opts))
        viewTemp.imageViewLoginOfflineEncyclopedia.setImageBitmap(BitmapFactory.decodeResource(resources, R.drawable.book_icon, opts))
