        ...
        tempView.imageViewFragmentSocialsAdd.setOnClickListener {
            ...
            if(!Data.player.socials.any { it.username == enteredUsername } && enteredUsername.isNotEmpty()){
                when(tempView.tabLayoutSocials.selectedTabPosition) {
                    1 -> {
                        Data.player.requestSocialAlly(enteredUsername, "",tempView.context).addOnCompleteListener {
            ...
            class Node(
                ...
                init {
                    if(index < socials.size){
                        ...
                        val dr: RoundedBitmapDrawable = RoundedBitmapDrawableFactory.create(context.resources, socials[index].bitmap)
                        dr.cornerRadius = 15f
                        dr.isCircular = true
                        ...
                        popup.setOnMenuItemClickListener { menuItem ->
                            when(menuItem.title){
                                "Ally" -> {
                                    ...
                                    Data.player.requestSocialAlly(Data.player.username, socials[index].bitmapId, context).addOnSuccessListener {
